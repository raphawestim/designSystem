...
function iniciarComponentesIndex() {
    ...
    $('#btContraste').on('click', function() {
        $('#wrapperPagina').toggleClass('alto-contraste');
        $(this).toggleClass('active');
    });
    
    $('#btFonteDyslexia').on('click', function() {
        $('body').toggleClass('font-family-dyslexia');
        $(this).toggleClass('active');
    });

    $('#btTamanhoFonte').on('click', function() {
        var tamanhoAtual = $('body').attr('data-tamanho-fonte');
        var proximoTamanho = 1;
        $(this).addClass('active');

        if(tamanhoAtual) {
            proximoTamanho = parseInt(tamanhoAtual, 10) + 1;
        ...
        $('body').attr('data-tamanho-fonte', proximoTamanho);
...
function abrirModalVideoMenu(scoClique){
    ...
    var jwplayerSetup = getJwplayerSetupObj(scoClique+'.mp4', scoClique+'.png', estrutura.midiaStreaming, estrutura.caminhoStreaming);
